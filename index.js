    ...
    .then((productos) => {
      productos.forEach((productos) => {
        divProductos.innerHTML += `
            ...
            <p class="card-text">${productos.medida}</p>
            <p class="precio">$<span>${productos.precio}</span></p>
            <button class="btn-agregar btn btn-dark" data-id="${productos.id}">Agregar al carrito</button>
            </div>
            </div>
            `;
      });
...
const mostrarCarrito = () => {
    ...
    sidebar.innerHTML += `
        <div class="caja--carrito">
          <div class="caja--carrito--datos">
            ...
            <p class="subtotalNumero">$${precio * cantidad}</p>
            <div>
              <button class="btn btn-dark btn-restar btn-restar-accion" data-id="${id}"><img src="./img/bin.png" class="img-carrito btn-restar-accion" data-id="${id}" alt=""/></button>
          </div>
          </div>    
        </div>
        `;
  ...
  <div class="divTotal"><p>Total: $${total}<p></div>

  <div class="botones-sidebar">
  <button class="btn btn-dark btn-limpiar">Limpiar carrito</button>
...
const comprar = () => {
  ...
  swalWithBootstrapButtons
    .fire({
      ...
      text: "Si continuas ya no podrás modificar el carrito de compras!",
      icon: "info",
    ...
    .then((result) => {
      if (result.isConfirmed) {
        ...
        swalWithBootstrapButtons.fire(
          ...
          "Un representante se pondra en contacto con usted",
          "success"
        );
